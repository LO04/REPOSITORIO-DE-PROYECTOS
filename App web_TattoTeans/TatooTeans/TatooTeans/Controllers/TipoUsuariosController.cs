...
namespace TatooTeans.Controllers
{
    public class TipoUsuariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Descripcion")] TipoUsuario tipoUsuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Descripcion")] TipoUsuario tipoUsuario)
        {
            if (ModelState.IsValid)
            {
