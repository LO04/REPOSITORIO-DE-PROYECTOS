...
namespace TatooTeans.Controllers
{
    public class CategoriaProductoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Nombre")] CategoriaProducto categoriaProducto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nombre")] CategoriaProducto categoriaProducto)
        {
            if (ModelState.IsValid)
            {
